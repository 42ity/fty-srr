...
static auto initSrrFeatures = []() {
    ...
    tmp[F_ALERT_AGENT].m_requiredIn  = {"1.0", "2.0", "2.1", "2.2", "2.3", "2.4", "2.5"};
    ...
    tmp[F_ASSET_AGENT].m_requiredIn  = {"1.0", "2.0", "2.1", "2.2", "2.3", "2.4", "2.5"};
    ...
    tmp[F_AUTOMATIC_GROUPS].m_requiredIn  = {"2.1", "2.2", "2.3", "2.4", "2.5"};
    ...
    tmp[F_AUTOMATION_SETTINGS].m_requiredIn  = {"1.0", "2.0", "2.1", "2.2", "2.3", "2.4", "2.5"};
    ...
    tmp[F_AUTOMATIONS].m_requiredIn  = {"1.0", "2.0", "2.1", "2.2", "2.3", "2.4", "2.5"};
    ...
    tmp[F_DISCOVERY_SETTINGS].m_requiredIn  = {"2.2", "2.3", "2.4", "2.5"};
    ...
    tmp[F_DISCOVERY_AGENT_SETTINGS].m_requiredIn  = {"2.2", "2.3", "2.4", "2.5"};
    ...
    tmp[F_MASS_MANAGEMENT].m_requiredIn  = {"1.0", "2.0", "2.1", "2.2", "2.3", "2.4", "2.5"};
    ...
    tmp[F_MONITORING_FEATURE_NAME].m_requiredIn  = {"1.0", "2.0", "2.1", "2.2", "2.3", "2.4", "2.5"};
    ...
    tmp[F_NETWORK].m_requiredIn  = {"1.0", "2.0", "2.1", "2.2", "2.3", "2.4", "2.5"};
    ...
    tmp[F_NETWORK_HOST_NAME].m_requiredIn  = {"2.2", "2.3", "2.4", "2.5"};
    ...
    tmp[F_NETWORK_AGENT_SETTINGS].m_requiredIn  = {"2.2", "2.3", "2.4", "2.5"};
    ...
    tmp[F_NETWORK_PROXY].m_requiredIn  = {"2.3", "2.4", "2.5"};
    ...
    tmp[F_NOTIFICATION_FEATURE_NAME].m_requiredIn  = {"1.0", "2.0", "2.1", "2.2", "2.3", "2.4", "2.5"};
    ...
    tmp[F_RSYSLOG_FEATURE_NAME].m_requiredIn  = {"2.1", "2.2", "2.3", "2.4", "2.5"};
    ...
    tmp[F_SECURITY_WALLET].m_requiredIn  = {"1.0", "2.0", "2.1", "2.2", "2.3", "2.4", "2.5"};
    ...
    tmp[F_SECURITY_WALLET_CAM].m_requiredIn  = {"2.3", "2.4", "2.5"};
    ...
    tmp[F_USER_SESSION_MANAGEMENT_FEATURE_NAME].m_requiredIn  = {"2.1", "2.2", "2.3", "2.4", "2.5"};
    ...
    tmp[F_VIRTUAL_ASSETS].m_requiredIn  = {"1.0", "2.0", "2.1", "2.2", "2.3", "2.4", "2.5"};
    ...
    tmp[F_VIRTUALIZATION_SETTINGS].m_requiredIn  = {"2.1", "2.2", "2.3", "2.4", "2.5"};
    ...
    tmp[F_AI_SETTINGS].m_requiredIn  = {"2.1", "2.2", "2.3", "2.4", "2.5"};
    ...
    tmp[F_TIMEZONE_SETTINGS].m_requiredIn  = {"2.3", "2.4", "2.5"};
    ...
    tmp[F_NTP_SETTINGS].m_requiredIn  = {"2.3", "2.4", "2.5"};
    tmp[F_NTP_SETTINGS].m_restart     = true;
    tmp[F_NTP_SETTINGS].m_reset       = false;

    tmp[F_GRAPHITE_SETTINGS];
    tmp[F_GRAPHITE_SETTINGS].m_id          = F_GRAPHITE_SETTINGS;
    tmp[F_GRAPHITE_SETTINGS].m_name        = F_GRAPHITE_SETTINGS;
    tmp[F_GRAPHITE_SETTINGS].m_description = TRANSLATE_ME("srr_graphite_settings");
    tmp[F_GRAPHITE_SETTINGS].m_agent       = CONFIG_AGENT_NAME;
    tmp[F_GRAPHITE_SETTINGS].m_requiredIn  = {"2.4", "2.5"};
    tmp[F_GRAPHITE_SETTINGS].m_restart     = true;
    tmp[F_GRAPHITE_SETTINGS].m_reset       = false;

    tmp[F_ALERT_AGENT_SETTINGS];
    tmp[F_ALERT_AGENT_SETTINGS].m_id          = F_ALERT_AGENT_SETTINGS;
    tmp[F_ALERT_AGENT_SETTINGS].m_name        = F_ALERT_AGENT_SETTINGS;
    tmp[F_ALERT_AGENT_SETTINGS].m_description = TRANSLATE_ME("srr_alert-agent-settings");
    tmp[F_ALERT_AGENT_SETTINGS].m_agent       = CONFIG_AGENT_NAME;
    tmp[F_ALERT_AGENT_SETTINGS].m_requiredIn  = {"2.5"};
    tmp[F_ALERT_AGENT_SETTINGS].m_restart     = true;
    tmp[F_ALERT_AGENT_SETTINGS].m_reset       = false;
...
static auto initSrrGroups = []() {
    ...
    tmp[G_ASSETS].m_fp.push_back(SrrFeaturePriorityStruct(F_ALERT_AGENT_SETTINGS, 6));
    tmp[G_ASSETS].m_fp.push_back(SrrFeaturePriorityStruct(F_ALERT_AGENT, 7));
    tmp[G_ASSETS].m_fp.push_back(SrrFeaturePriorityStruct(F_AUTOMATION_SETTINGS, 8));
    tmp[G_ASSETS].m_fp.push_back(SrrFeaturePriorityStruct(F_AUTOMATIONS, 9));
    ...
    tmp[G_MONITORING].m_fp.push_back(SrrFeaturePriorityStruct(F_GRAPHITE_SETTINGS, 2));
    ...
    tmp[G_DATETIME_SETTINGS];
    tmp[G_DATETIME_SETTINGS].m_id           = G_DATETIME_SETTINGS;
    tmp[G_DATETIME_SETTINGS].m_name         = G_DATETIME_SETTINGS;
    tmp[G_DATETIME_SETTINGS].m_description  = TRANSLATE_ME("srr_group-datetime-settings");
    tmp[G_DATETIME_SETTINGS].m_restoreOrder = restoreOrder++;

    tmp[G_DATETIME_SETTINGS].m_fp.push_back(SrrFeaturePriorityStruct(F_TIMEZONE_SETTINGS, 1));
    tmp[G_DATETIME_SETTINGS].m_fp.push_back(SrrFeaturePriorityStruct(F_NTP_SETTINGS, 2));

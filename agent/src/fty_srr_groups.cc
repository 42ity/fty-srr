...
static auto initSrrFeatures = []() {
    ...
    tmp[F_ALERT_AGENT].m_requiredIn  = {"1.0", "2.0", "2.1", "2.2", "2.3", "2.4"};
    ...
    tmp[F_ASSET_AGENT].m_requiredIn  = {"1.0", "2.0", "2.1", "2.2", "2.3", "2.4"};
    ...
    tmp[F_AUTOMATIC_GROUPS].m_requiredIn  = {"2.1", "2.2", "2.3", "2.4"};
    ...
    tmp[F_AUTOMATION_SETTINGS].m_requiredIn  = {"1.0", "2.0", "2.1", "2.2", "2.3", "2.4"};
    ...
    tmp[F_AUTOMATIONS].m_requiredIn  = {"1.0", "2.0", "2.1", "2.2", "2.3", "2.4"};
    ...
    tmp[F_DISCOVERY_SETTINGS].m_requiredIn  = {"2.2", "2.3", "2.4"};
    ...
    tmp[F_DISCOVERY_AGENT_SETTINGS].m_requiredIn  = {"2.2", "2.3", "2.4"};
    ...
    tmp[F_MASS_MANAGEMENT].m_requiredIn  = {"1.0", "2.0", "2.1", "2.2", "2.3", "2.4"};
    ...
    tmp[F_MONITORING_FEATURE_NAME].m_requiredIn  = {"1.0", "2.0", "2.1", "2.2", "2.3", "2.4"};
    ...
    tmp[F_NETWORK].m_requiredIn  = {"1.0", "2.0", "2.1", "2.2", "2.3", "2.4"};
    ...
    tmp[F_NETWORK_HOST_NAME].m_requiredIn  = {"2.2", "2.3", "2.4"};
    ...
    tmp[F_NETWORK_AGENT_SETTINGS].m_requiredIn  = {"2.2", "2.3", "2.4"};
    ...
    tmp[F_NETWORK_PROXY].m_requiredIn  = {"2.3", "2.4"};
    ...
    tmp[F_NOTIFICATION_FEATURE_NAME].m_requiredIn  = {"1.0", "2.0", "2.1", "2.2", "2.3", "2.4"};
    ...
    tmp[F_RSYSLOG_FEATURE_NAME].m_requiredIn  = {"2.1", "2.2", "2.3", "2.4"};
    ...
    tmp[F_SECURITY_WALLET].m_requiredIn  = {"1.0", "2.0", "2.1", "2.2", "2.3", "2.4"};
    ...
    tmp[F_SECURITY_WALLET_CAM].m_requiredIn  = {"2.3", "2.4"};
    ...
    tmp[F_USER_SESSION_MANAGEMENT_FEATURE_NAME].m_requiredIn  = {"2.1", "2.2", "2.3", "2.4"};
    ...
    tmp[F_VIRTUAL_ASSETS].m_requiredIn  = {"1.0", "2.0", "2.1", "2.2", "2.3", "2.4"};
    ...
    tmp[F_VIRTUALIZATION_SETTINGS].m_requiredIn  = {"2.1", "2.2", "2.3", "2.4"};
    ...
    tmp[F_AI_SETTINGS].m_requiredIn  = {"2.1", "2.2", "2.3", "2.4"};
    ...
    tmp[F_TIMEZONE_SETTINGS].m_requiredIn  = {"2.3", "2.4"};
    ...
    tmp[F_NTP_SETTINGS].m_requiredIn  = {"2.3", "2.4"};
    ...
    tmp[F_GRAPHITE_SETTINGS].m_requiredIn  = {"2.4"};
